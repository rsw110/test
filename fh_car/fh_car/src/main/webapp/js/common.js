$(document).ready(function(){
	var htmlCode = '<table width="60%" border="1px" align="center"><tr><td><a onclick="goFirst()">首页</a></td><td><a onclick="goPri()">上一页</a></td>'+
				   ...
				   '<td><a onclick="goNext()">下一页</a></td><td><a onclick="goLast()">尾页</a></td><td>展示<select id="pageSize" onchange="changePageSize()"><option value="3">3</option><option value="4">4</option><option value="6">6</option></select>条</td><td><input type="text" id="targetPage" style="width: 60px">'+
